...
df <- df %>%
  ...
  mutate(
    DIQ010 = ifelse(DIQ010 == 1, "Has Diabetes", "No Diabetes"), #"has diabetes was first 'yes'
    DRD370B = ifelse(DRD370B == 1, "Consumes Ahi", "No Ahi") #was 'yes' and 'no'
  )
